...
{
  Addr_t tag = CacheGeneric<State, Addr_t, Energy>::calcTag(addr);
  ...
  Line **theSet = &content[CacheGeneric<State, Addr_t, Energy>::calcIndex4Tag(tag)];
...
typename CacheDM<State, Addr_t, Energy>::Line *CacheDM<State, Addr_t, Energy>::findLinePrivate(Addr_t addr)
{
  ...
  Line *line = content[CacheGeneric<State, Addr_t, Energy>::calcIndex4Tag(tag)];
...
typename CacheDMSkew<State, Addr_t, Energy>::Line *CacheDMSkew<State, Addr_t, Energy>::findLinePrivate(Addr_t addr)
{
  ...
  // BEGIN Skew cache
  Addr_t tag2 = CacheGeneric<State, Addr_t, Energy>::calcTag(addr ^ (addr>>7));
  line = content[CacheGeneric<State, Addr_t, Energy>::calcIndex4Tag(tag2)];
...
{ 
  ...
  // BEGIN Skew cache
  Addr_t tag2 = CacheGeneric<State, Addr_t, Energy>::calcTag(addr ^ (addr>>7));
  Line *line2 = content[CacheGeneric<State, Addr_t, Energy>::calcIndex4Tag(tag2)];
